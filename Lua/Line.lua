...
function conky_drawLine()
	...
	cairo_line_to (cr, 210, 350);
	cairo_set_source_rgba (cr, 51, 153, 255, 0.9);
	cairo_stroke (cr);

	--3th-Right
	cairo_set_line_width (cr, 2);
	cairo_move_to (cr, 290, 350); 
	...
	--1th-Right
	cairo_set_line_width (cr, 2);
	cairo_move_to (cr, 270, 250); 
	cairo_line_to (cr, 423, 250);
	cairo_set_source_rgba (cr, 51, 153, 255, 0.9);
	cairo_stroke (cr);

	--InsidRight
	cairo_move_to (cr, 315, 480);
	cairo_line_to (cr, 248, 120);

	--InsideLeft
	cairo_move_to (cr, 187, 480);
	cairo_line_to (cr, 248, 120);
	...
	cairo_line_to (cr, 220, 480);

	--br
	cairo_move_to (cr, 270, 480);
